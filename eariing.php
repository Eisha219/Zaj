...
<section class="new_arrival my-5">
  <div class="container">
    <h2 class="section-subheading">Earrings Collection</h2>
  </div>
  <div class="container mt-4" id="new-arrival-content">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <a href="productdetail.php" class="hover-text">
                <div class="card shop-card">
                    <img src="images/earingsphotos/stone.png" class="card-img-top" alt="Image 1">
                    <div class="overlay-image">
                        <img src="images/earingsphotos/white.png" alt="Image 2">
                    </div>
                ...
                <div class="card-body">
                    <h5 class="card-title">black earing</h5>
        ...
        <div class="col">
            <a href="productdetail.php" class="hover-text">
                <div class="card shop-card">
                    <img src="images/earingsphotos/blue.png" class="card-img-top" alt="Image 1">
                    <div class="overlay-image">
                ...
                <div class="card-body">
                    <h5 class="card-title">blue earing</h5>
                    <div class="d-flex justify-content-between">
    ...
    <a href="productdetail.php" class="hover-text">
        ...
        <div class="card-body">
            <h5 class="card-title">pink earing</h5>
            <div class="d-flex justify-content-between">
                <p class="card-text">$31.99</p>
                <p class="card-text text-decoration-line-through">$18.99</p>
            </div>
     ...
     <div class="col">
        <a href="productdetail.php" class="hover-text">
            ...
            <div class="card-body">
                <h5 class="card-title">white earing</h5>
                <div class="d-flex justify-content-between">
  ...
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
    ...
    <div class="col">
        <a href="productdetail.php" class="hover-text">
            <div class="card shop-card">
                <img src="images/earingsphotos/Black.PNG" class="card-img-top" alt="Image 1">
                <div class="overlay-image">
                    <img src="images/earingsphotos/Blue.PNG" alt="Image 2">
                </div>
                <div class="card-actions">
                    <button class="action-btn" aria-label="add to cart">
                        <i class="fas fa-cart-plus"></i>
            ...
            <div class="card-body">
                <h5 class="card-title">Golden Earring</h5>
                <div class="d-flex justify-content-between">
                    <p class="card-text">$21.99</p>
                    <p class="card-text text-decoration-line-through">$19.99</p>
                </div>
    ...
    <div class="col">
        <a href="productdetail.php" class="hover-text">
            <div class="card shop-card">
                ...
                <div class="overlay-image">
                    <img src="images/earingsphotos/ear13.jpg" alt="Image 2">
                </div>
                <div class="card-actions">
                    <button class="action-btn" aria-label="add to cart">
                        <i class="fas fa-cart-plus"></i>
            ...
            <div class="card-body">
                <h5 class="card-title">Red earings</h5>
                <div class="d-flex justify-content-between">
                    <p class="card-text">$31.99</p>
                    <p class="card-text text-decoration-line-through">$18.99</p>
                </div>
   ...
   <!-- Item 7 -->
 <div class="col">
<a href="eariing.html" class="hover-text">
    <div class="card shop-card">
        <img src="images/earingsphotos/ear9.jpg" class="card-img-top" alt="Image 1">
        <div class="overlay-image">
...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mt-4">
    ...
    <div class="col">
        <a href="productdetail.php" class="hover-text">
            <div class="card shop-card">
                <img src="images/earingsphotos/ear4.jpg" class="card-img-top" alt="Image 1">
                <div class="overlay-image">
                    <img src="images/earingsphotos/ear3.jpg" alt="Image 2">
                </div>
                <div class="card-actions">
...
<a href="eariing.html" class="hover-text">
    <div class="card shop-card">
        <img src="images/earingsphotos/ear11.jpg" class="card-img-top" alt="Image 1">
        <div class="overlay-image">
            <img src="images/earingsphotos/ear3.jpg" alt="Image 2">
        </div>
        <div class="card-actions">
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
      ...
      const items = document.querySelectorAll('.row .col'); // Selecting all items
      ...
      // Generate initial pagination links
