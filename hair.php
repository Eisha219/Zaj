...
<section class="new_arrival my-5">
  <div class="container">
    <h2 class="section-subheading">Hair Accessories</h2>
  </div>
  <div class="container mt-4" id="new-arrival-content">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <a href="productdetail.php" class="hover-text">
                <div class="card shop-card">
                    <img src="images/pins/pin1.jpg" class="card-img-top" alt="Image 1">
                    <div class="overlay-image">
                        <img src="images/pins/pin2.jpg" alt="Image 2">
                    </div>
                ...
                <div class="card-body">
                    <h5 class="card-title">Blue pin</h5>
        ...
        <div class="col">
            <a href="productdetail.php" class="hover-text">
                <div class="card shop-card">
                    <img src="images/pins/pin3.jpg" class="card-img-top" alt="Image 1">
                    <div class="overlay-image">
                        <img src="images/pins/pin2.jpg" alt="Image 2">
                    </div>
                    <div class="card-actions">
                ...
                <div class="card-body">
                    <h5 class="card-title">pink pin</h5>
                    <div class="d-flex justify-content-between">
